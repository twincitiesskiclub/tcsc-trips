...
def test_dashboard_builds_valid_specs_and_preserves_full_history(empty, seasons):
    ...
    filters = Filters(seasons=seasons, kinds=["practice"])
    ...
    load.assert_called_once_with(Filters(kinds=["practice"]))
